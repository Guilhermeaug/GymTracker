...
abstract class $ExerciseCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, int series, int repetitions});
}
...
class _$_Exercise implements _Exercise {
  ...
  @override
  String toString() {
    return 'Exercise(id: $id, name: $name, series: $series, repetitions: $repetitions)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, series, repetitions);
...
abstract class _Exercise implements Exercise {
  const factory _Exercise(
      ...
      required final int repetitions}) = _$_Exercise;
